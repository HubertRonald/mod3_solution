(function () {
    ...
    function MenuSearchService(MenuService, $rootScope) { 
        ...
        service.getMatchedMenuItems = function (matchTerm) { 
            found = [];
            if (!matchTerm) {
            ...
            menu.forEach(function (value) {
                if  ((value.name.toLowerCase().indexOf(matchTerm.toLowerCase())+1)||
                (value.description.toLowerCase().indexOf(matchTerm.toLowerCase())+1)) found.push(value);
